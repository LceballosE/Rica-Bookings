...
const MasonaryLayout: FC<IGridLayoutProps> = ({ value, grid, view }) => {
      ...
      <MasonryGrid className="masonry-spacing">
        <Gallery>
          {value?.map((data: GalleryData) => (
            <div className={`${grid.gridSize === 3 && "col-xl-4"} ${grid.gridSize === 4 && "col-xl-3 col-lg-4"} col-sm-6 popular grid-item wow fadeInUp p-2`} key={data.id}>

...
const SelectCity: FC<ISelectCityProps> = ({ value, cityData }) => {
  ...
  return (
    <div className="form-group">
      <input type="text" className="form-control open-select" id="exampleInputEmail1" placeholder={value} defaultValue={selectedCity} onChange={() => setIsComponentVisible(!isComponentVisible)} />

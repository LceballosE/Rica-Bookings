...
const GoogleMap: FC = () => {
  ...
  return (
    <CustomLayout logo="dark" title="light_header" userBgClass="user user-light" loader="map-loader">
      <HomeBanner />
      <MapView value={data} side={"right"} gridType={"grid-view"} type="restaurant">
        <GoogleMapComponent />
      </MapView>
    </CustomLayout>
  );

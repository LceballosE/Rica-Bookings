...
const LeftSidebar: FC = () => {
  ...
  return (
    <CustomLayout logo="dark" title="light_header" userBgClass="user user-light" loader="right">
      <HomeBanner />
      <GridView size={3} value={data} type={"restaurant"} gridType="grid-view" gridOption={true} topFilter={false} side="right" grid4Img={true} />
    </CustomLayout>
  );
};

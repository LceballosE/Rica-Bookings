  ...
  return (
    <CustomLayout title="inner-page overlay-black" userBgClass="user user-light" loader="pre">
      ...
      <div className="right-filter-items">
        <GridView size={3} gridType={"list-view"} side={"left"} value={data} topFilter={false} gridOption={true} grid4Img={false} type="tour" filter={false} view="slider" gridSelect={true} />
      </div>
    </CustomLayout>
  );
};
